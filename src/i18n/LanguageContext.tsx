...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  'pt-BR': {
    ...
    'page.generator.eyebrow': 'Scale Engine', 'page.generator.title': 'Comece pela tonalidade.', 'page.generator.description': 'Monte a base do seu próximo loop com escolhas rápidas e precisas.',
    'page.library.eyebrow': 'Cloud Library', 'page.library.title': 'Suas fagulhas, reunidas.', 'page.library.description': 'Acesse loops salvos e retome uma ideia quando ela pedir passagem.',
    'page.presets.eyebrow': 'Curated Packs', 'page.presets.title': 'Atalhos com personalidade.', 'page.presets.description': 'Escolha um ponto de partida e leve a ideia para o seu território.',
    'page.chords.eyebrow': 'Harmonizer', 'page.chords.title': 'Encontre o acorde certo.', 'page.chords.description': 'Explore o campo harmônico da escala ativa sem sair do fluxo.',
    'page.profile.eyebrow': 'Producer Profile', 'page.profile.title': 'Seu espaço de produtor.', 'page.profile.description': 'Ajuste sua identidade e preferências do Studio Hub.',
    'page.faq.eyebrow': 'Quick Guide', 'page.faq.title': 'Dúvidas fora do caminho.', 'page.faq.description': 'Respostas curtas para manter sua sessão em movimento.',
    'page.support.eyebrow': 'Studio Support', 'page.support.title': 'Vamos resolver juntos.', 'page.support.description': 'Envie uma solicitação para a equipe do Fagulha.',
